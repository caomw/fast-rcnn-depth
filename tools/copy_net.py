...
caffe.set_mode_cpu()
net = caffe.Net('/nfs.yoda/xiaolonw/fast_rcnn/fast-rcnn-depth/scripts/pre_gan2/train.prototxt', caffe.TRAIN)
headfile = '/nfs.yoda/xiaolonw/torch_projects/weights4/head_r.txt'
f = open(headfile, 'r')

savename = '/nfs.yoda/xiaolonw/fast_rcnn/models_depth/pre_gan2/fast_rcnn_zero.caffemodel'
